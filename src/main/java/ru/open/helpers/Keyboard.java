...
public final class Keyboard {
    ...
    public void clickOnStatus(String numberOfClick) {
        int intNumberOfClick = Integer.parseInt(numberOfClick);
        if (intNumberOfClick > 0) {
            for (int i = 0; i < intNumberOfClick; i++) {
                robot.delay(1000);
